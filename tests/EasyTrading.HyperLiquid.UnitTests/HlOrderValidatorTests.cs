...
public sealed class HlOrderValidatorTests
{
    ...
    private static readonly AssetInfo BtcPerp = new(AssetId: 0, SzDecimals: 5, IsSpot: false);

    // PURR/USDC spot: szDecimals=0 → max price decimals = 8 - 0 = 8.
    private static readonly AssetInfo PurrSpot = new(AssetId: 10_000, SzDecimals: 0, IsSpot: true);
    ...
    {
        OrderValidator.Validate("BTC", price: 60_000m, size: 0.01m, BtcPerp, reduceOnly: false);
    }
    ...
    public void Integer_price_always_passes_even_with_many_sig_figs()
    {
        ...
        OrderValidator.Validate("BTC", price: 12_345_600m, size: 0.001m, BtcPerp, reduceOnly: false);
    }
    ...
    public void Price_with_max_sig_figs_passes()
    {
        ...
        OrderValidator.Validate("BTC", price: 1234.5m, size: 0.01m, BtcPerp, reduceOnly: false);
    }
    ...
    public void Size_at_szDecimals_limit_passes()
    {
        ...
        OrderValidator.Validate("BTC", price: 60_000m, size: 0.12345m, BtcPerp, reduceOnly: false);
    }
    ...
    public void Spot_uses_higher_price_decimal_ceiling()
    {
        ...
        OrderValidator.Validate("PURR/USDC", price: 0.12345m, size: 100m, PurrSpot, reduceOnly: false);
    }
    ...
    public void Zero_size_throws()
    {
        var ex = Assert.Throws<InvalidOrderException>(() =>
            OrderValidator.Validate("BTC", 60_000m, size: 0m, BtcPerp, reduceOnly: false));
    ...
    public void Negative_size_throws()
    {
        Assert.Throws<InvalidOrderException>(() =>
            OrderValidator.Validate("BTC", 60_000m, size: -0.01m, BtcPerp, reduceOnly: false));
    }
    ...
    public void Size_with_too_many_decimals_throws()
    {
        ...
        var ex = Assert.Throws<InvalidOrderException>(() =>
            OrderValidator.Validate("BTC", 60_000m, size: 0.123456m, BtcPerp, reduceOnly: false));
    ...
    public void Trailing_zeros_in_size_are_normalised()
    {
        ...
        var info = new AssetInfo(0, SzDecimals: 1, IsSpot: false);
        OrderValidator.Validate("X", price: 1234m, size: 0.10m, info, reduceOnly: false);
        OrderValidator.Validate("X", price: 1234m, size: 0.1m, info, reduceOnly: false);
    }
    ...
    public void Price_with_too_many_decimals_throws()
    {
        ...
        var ex = Assert.Throws<InvalidOrderException>(() =>
            OrderValidator.Validate("BTC", price: 1234.56m, size: 0.01m, BtcPerp, reduceOnly: false));
        Assert.Contains("decimal places", ex.Message, StringComparison.OrdinalIgnoreCase);
    }
    ...
    public void Price_with_too_many_sig_figs_throws()
    {
        ...
        var info = new AssetInfo(0, SzDecimals: 0, IsSpot: false);
        var ex = Assert.Throws<InvalidOrderException>(() =>
            OrderValidator.Validate("X", price: 1.00001m, size: 1m, info, reduceOnly: false));
    ...
    public void Zero_price_skips_price_check()
    {
        ...
        OrderValidator.Validate("BTC", price: 0m, size: 0.01m, BtcPerp, reduceOnly: false);
    }
    ...
    public void Notional_below_10_usd_throws()
    {
        ...
        var info = new AssetInfo(0, SzDecimals: 1, IsSpot: false);
        var ex = Assert.Throws<InvalidOrderException>(() =>
            OrderValidator.Validate("X", price: 1m, size: 1m, info, reduceOnly: false));
    ...
    public void Reduce_only_skips_min_notional_check()
    {
        ...
        OrderValidator.Validate("X", price: 1m, size: 1m, info, reduceOnly: true);
    }
    ...
    {
        var info = new AssetInfo(0, SzDecimals: 1, IsSpot: false);
        OrderValidator.Validate("X", price: 5m, size: 2m, info, reduceOnly: false);
    }
}
