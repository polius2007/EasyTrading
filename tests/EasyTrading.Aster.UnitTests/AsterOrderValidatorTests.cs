...
public sealed class AsterOrderValidatorTests
{
    ...
    private static readonly SymbolInfo BtcUsdt = new(
        Symbol:            "BTCUSDT",
        Status:            "TRADING",
        PricePrecision:    1,
        QuantityPrecision: 3,
    ...
    {
        OrderValidator.Validate(BtcUsdt, price: 60_000.1m, size: 0.001m, reduceOnly: false);
    }
    ...
    public void Zero_price_skips_price_and_notional_rules()
    {
        ...
        OrderValidator.Validate(BtcUsdt, price: 0m, size: 0.001m, reduceOnly: false);
    }
    ...
    public void Zero_size_throws()
    {
        var ex = Assert.Throws<InvalidOrderException>(() =>
            OrderValidator.Validate(BtcUsdt, price: 60_000m, size: 0m, reduceOnly: false));
    ...
    {
        var ex = Assert.Throws<InvalidOrderException>(() =>
            OrderValidator.Validate(BtcUsdt, price: 60_000m, size: 0.0005m, reduceOnly: false));
    ...
    {
        var ex = Assert.Throws<InvalidOrderException>(() =>
            OrderValidator.Validate(BtcUsdt, price: 60_000m, size: 1001m, reduceOnly: false));
    ...
    public void Size_not_aligned_to_step_throws()
    {
        ...
        var ex = Assert.Throws<InvalidOrderException>(() =>
            OrderValidator.Validate(BtcUsdt, price: 60_000m, size: 0.0015m, reduceOnly: false));
    ...
    public void Price_not_aligned_to_tick_throws()
    {
        ...
        var ex = Assert.Throws<InvalidOrderException>(() =>
            OrderValidator.Validate(BtcUsdt, price: 60_000.05m, size: 0.001m, reduceOnly: false));
    ...
    public void Below_min_notional_throws()
    {
        ...
        var ex = Assert.Throws<InvalidOrderException>(() =>
            OrderValidator.Validate(info, price: 1m, size: 1m, reduceOnly: false));
    ...
    public void Reduce_only_skips_min_notional()
    {
        ...
        OrderValidator.Validate(info, price: 1m, size: 1m, reduceOnly: true);
    }
}
