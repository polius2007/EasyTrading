...
/// <see cref="WebSocketClient"/> reconnects, we may have missed events that fired between
...
///   <item><description>On every <see cref="WebSocketClient.Reconnected"/> event, call
...
/// </remarks>
internal static class StreamGapFill
{
