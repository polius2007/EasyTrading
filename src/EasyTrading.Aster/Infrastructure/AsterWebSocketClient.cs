...
/// </remarks>
internal sealed class AsterWebSocketClient : IAsyncDisposable
{
    ...
    public AsterWebSocketClient(Func<CancellationToken, Task<Uri>> urlProvider, TimeSpan reconnectDelay, ILogger logger)
    {
    ...
    private async Task SendSubscribeAsync(string streamName, bool subscribe, CancellationToken ct)
    {
        ...
        var json = JsonSerializer.Serialize(envelope, AsterJsonOptions.Default);
